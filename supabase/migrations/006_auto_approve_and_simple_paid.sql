-- Director/admin creates → auto-approved
-- Mark paid: no mode/UTR required (defaults)
...
-- Simplified mark paid: mode/ref optional with safe defaults
...
begin
  ...
  insert into public.payment_events (
    ...
    row.id, 'paid', me.id, old, 'paid', null
  );
